...
- **Overall progress:** ✅ 3 / 5 phases done (60%) — 48 / 64 tasks
...
| 4 | [Listing + Pagination + forRootAsync + E2E + Mutation](./tasks/phase-04-listing-async-e2e-mutation.md) | 🔄 In Progress | 5/12 | HIGH | 2026-07-01 |
