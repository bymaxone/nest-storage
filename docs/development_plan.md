...
- **Overall progress:** 🔄 5 / 5 phases done (100%) — 63 / 64 tasks
- **Active phase:** — (released; 5.9 tag+publish awaits human after PR merges)
- **Blocked:** none
...
| 5 | [Release v0.1.0](./tasks/phase-05-release.md) | ✅ Done | 8/9 | LOW | 2026-07-01 |
| | **Total** | ✅ **5 / 5 phases** | **63 / 64 tasks** | — | — |
